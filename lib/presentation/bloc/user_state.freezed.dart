...
mixin _$UserState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<UserModel> user) data,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<UserModel> user)? data,
...
class _$DataImpl implements _Data {
  const _$DataImpl(final List<UserModel> user) : _user = user;
...
abstract class _Data implements UserState {
  const factory _Data(final List<UserModel> user) = _$DataImpl;
